...
def run(env, policy, args):
    ...
    # Example: Writing metrics to file after the loop (modify as needed)
    with open("detailed_metrics.txt", "a") as f:
        # Assuming you have a dictionary like ep_metrics or you extract values from ep_rewards
        for info in ep_rewards:
            # Replace with the actual keys you are using:
            f.write(
