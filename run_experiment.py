...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_norm_steps", type=int, default=50000)
    parser.add_argument("--n_itr", type=int, default=80000, help="Number of iterations of the learning algorithm")
